...
parser.add_argument('--general_model_path', type=str, default='/z_data/pretrained/')
parser.add_argument('--dataset_path', type=str, default='/z_data/yunhang/MedData/')
...
parser.add_argument('--root_path', type=str, default='/z_data/yunhang/Code/MedToolLab')
parser.add_argument("--device", type=str, default="cuda:6", help='Device / device_map, e.g. "cuda:3" or "auto"')
...
for no, sample in enumerate(tqdm(test_qa)):
    ...
    if "Llama" in args.model:
        ...
        final_decision = mdagents_test(question, args.root_path, args)
